sparql(
    "SELECT DISTINCT ?carrera ?sede ?universidad ?region ?arancel WHERE { GRAPH <http://verdata.cl/graphs/ofertaacademica> {?c <http://verdata.cl/graphs/ofertaacademica/carrera/nombreCarrera> ?carrera." +
...
"?c <http://verdata.cl/graphs/ofertaacademica/carrera/valorArancel> ?arancel}} ORDER BY DESC(?arancel) LIMIT 50",
